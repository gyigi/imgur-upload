...
app.initializers.add('imgur-upload', () => {
    app.extensionData
        ...
        .registerSetting(
            {
                setting: 'imgur-upload.admin.settings.API-URL',
                label: app.translator.trans('imgur-upload.admin.settings.API-URL'),
                type: 'text','https://api.imgur.com/v3/upload'
            }
        )
        .registerSetting(
            {
                setting: 'imgur-upload.admin.settings.image-URL',
                label: app.translator.trans('imgur-upload.image-URL'),
                type: 'text','https://i.imgur.com'
            }   
        )
});
